#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File: /home/ywatanabe/proj/scitex-ui/tests/examples/test_01_list_components.py

"""Smoke test for examples/01_list_components.py.
...
EXAMPLE = Path(__file__).resolve().parents[2] / "examples" / "01_list_components.py"
