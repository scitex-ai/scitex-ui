...
# (project=scitex-ui, owner=ywatanabe1989, repo=scitex-ui,
...
TMPDIR="/tmp/publish-scitex_ui-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-ui dist/* uploaded to PyPI via manual OIDC trusted publishing"
